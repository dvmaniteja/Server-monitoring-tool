...
<body>
<form action="metrics4.php" method="GET">
...
<center><h1 style="font-family:Trebuchet MS;font-size:250%">SELECT MULTIPLE DEVICES</h1></center>
...
$data1 = mysqli_query( $link10,"SELECT IP,PORT, COMMUNITY, BOTHS FROM mani_DEVICES_INTERFACES_SELECTED") or die(mysqli_error()); 
...
while ($row = mysqli_fetch_array($data1))
			...
			print "<td><input type='checkbox' name='check_list3[]' value='$devaa-$row[0]-$row[1]-$row[2]'/></td>";

...
<body>
<form action="graph2.php" method="GET">
...
<tr>
			<td>HOURLY GRAPH</td>
			<td><input type='checkbox' name='check_list2[]' value='-1h'></td>
		</tr>
		
		<tr>
			<td>DAILY GRAPH</td>
			<td><input type='checkbox' name='check_list2[]' value='-1d'></td>
		</tr>

		<tr>
			<td>WEEKLY GRAPH</td>
			<td><input type='checkbox' name='check_list2[]' value='-1w'></td>
		</tr>

		<tr>
			<td>MONTHLY GRAPH</td>
			<td><input type='checkbox' name='check_list2[]' value='-1m'></td>
		</tr>

			<tr>
			<td>YEARLY GRAPH</td>
			<td><input type='checkbox' name='check_list2[]' value='-1y'></td>
		</tr>
